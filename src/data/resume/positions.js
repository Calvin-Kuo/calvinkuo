const positions = [
  {
    ...
    points: [
      'Lead product strategy for AT&T’s large-scale data & AI platforms, delivering predictive diagnostics, real-time geolocation intelligence, and automation capabilities that strengthen network reliability and elevate customer experience across millions of devices.',
      'Drive the development of advanced GenAI solutions, including LLM-powered diagnostics and retrieval-augmented analytics, to help engineering and operations teams identify issues faster, uncover optimization opportunities, and accelerate problem resolution.',
      'Oversee end-to-end architecture for high-volume telemetry ecosystems, guiding design decisions across ingestion, data quality, ML pipelines, and analytics layers to ensure accuracy, resilience, and scalability for mission-critical workloads.',
      'Partner closely with OEMs such as Google and Samsung to define device-level integration roadmaps for over 100 device model variants, validate new capabilities, and ensure interoperability across Android ecosystems, resulting in more reliable firmware and improved performance KPIs.',
      'Lead cross-functional teams across engineering, AI/ML, design, and business units, aligning on priorities, resolving technical blockers, and delivering AI-driven features and platform enhancements with consistent velocity.',
      'Define success metrics and operational guardrails that link engineering delivery with customer outcomes, ensuring data quality, model performance, and product decisions directly contribute to measurable improvements in network and device experience.',
