const positions = [
  {
    ...
    points: [
      'Lead product strategy for AT&T’s large-scale data and AI platforms, delivering predictive diagnostics, real-time geolocation intelligence, and automation capabilities that strengthen network reliability and elevate customer experience across millions of mobile devices.',
  ...
  },
  {
    ...
    points: [
      'Led the 0→1 development of an enterprise-scale ads intelligence platform, transforming multi-petabyte viewership and behavioral datasets into actionable insights that powered a multi-billion-dollar hyper-personalized advertising ecosystem and informed business-wide monetization strategies.',
      ...
      'Drove end-to-end execution of ML feature deployment, improving experimentation velocity and accelerating release cycles through optimized CI/CD workflows and automated pipeline validation.',
  ...
  },
  {
    ...
    points: [
      'Led the modernization of a large-scale retail analytics platform, driving the transition from legacy on-prem systems to cloud-native architectures on Azure, enabling faster insights generation and more scalable operations across thousands of retail locations nationwide.',
      'Defined product vision and roadmap for containerized microservices leveraging Docker and Kubernetes, streamlining ingestion and processing of high-volume transactional datasets and delivering double-digit reductions in latency and deployment friction.',
      'Partnered with engineering, architecture, and business stakeholders to champion Infrastructure-as-Code and cloud automation best practices, improving delivery velocity and aligning technical milestones with high-impact retail and operations priorities.',
  ...
  },
  {
    ...
    points: [
      'Defined product strategy and feature concepts for next-generation E-911 public safety solutions, leveraging geolocation and network intelligence to streamline dispatch workflows and improve first-responder coordination at national scale.',
      ...
      'Drove workflow and process optimization initiatives that enhanced operational efficiency and reduced program overhead, contributing to significant cost savings and improved delivery predictability for emergency communications projects.',
